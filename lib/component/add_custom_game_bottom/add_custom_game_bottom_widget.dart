...
import 'add_custom_game_bottom_model.dart';
export 'add_custom_game_bottom_model.dart';

class AddCustomGameBottomWidget extends StatefulWidget {
  const AddCustomGameBottomWidget({
    super.key,
    required this.gameParameter,
    required this.holeNumber,
    required this.listOfPlayersRef,
    required this.listOfPlayers,
  });

  final GamesRecord? gameParameter;
  final int? holeNumber;
  final List<DocumentReference>? listOfPlayersRef;
  final List<UsersRecord>? listOfPlayers;

  @override
  State<AddCustomGameBottomWidget> createState() =>
      _AddCustomGameBottomWidgetState();
}

class _AddCustomGameBottomWidgetState extends State<AddCustomGameBottomWidget>
    with TickerProviderStateMixin {
  late AddCustomGameBottomModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddCustomGameBottomModel());
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await CustomGameScoresRecord.collection
                                  .doc()
                                  .set(createCustomGameScoresRecordData(
                                    holeNumber: widget.holeNumber,
                                    score: int.tryParse(
                                        _model.scoreTextController.text),
                                    gameRef: widget.gameParameter?.reference,
                                    gameType: _model.dropDownValue,
                                    userName: _model.winnerValue,
                                    userRef: widget.listOfPlayers
                                        ?.where((e) =>
