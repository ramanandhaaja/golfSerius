            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (currentUserDocument?.currentGame?.id != null &&
                      currentUserDocument?.currentGame?.id != '')
                    Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(10.0, 12.0, 20.0, 0.0),
                      child: AuthUserStreamWidget(
                        builder: (context) => StreamBuilder<GamesRecord>(
                          stream: GamesRecord.getDocument(
                              currentUserDocument!.currentGame!),
                              ...
                              onTap: () async {
                                context.pushNamed(
                                  ...
                                  extra: <String, dynamic>{
                                    'gameParameter': containerGamesRecord,
                                  },
                                );
                              },
                              child: Container(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        valueOrDefault<String>(
                                          containerGamesRecord.courseName,
                                          'xxx Golf Course',
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .titleLarge
                      ...
                      child: Padding(
                        ...
                        child: AuthUserStreamWidget(
                          builder: (context) => FFButtonWidget(
                            onPressed: () async {
                              context.pushNamed('GameCreate');
                            },
                            text: 'Create my own game !',
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                        ...
                                        child: Padding(
                                          padding:
                                              const EdgeInsetsDirectional.fromSTEB(
                                                  13.0, 6.5, 13.0, 6.5),
                                          child: Text(
                                            listViewGamesRecord.numberOfPlayer
                                                .toString(),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                      ...
                                      if ((listViewGamesRecord.gameCompleted ==
                                              false) &&
                                          ...
                                          builder: (context) => InkWell(
                                            ...
                                            onTap: () async {
                                              if (currentUserDocument
                                                ...
                                                await showDialog(
                                                  ...
                                                  builder:
                                                    ...
                                                    return AlertDialog(
                                                      title: const Text(
                                                          'You already joined a game'),
                                                      content: const Text(
                                                          'End the current game to join this game !'),
                                                      actions: [
                                                        TextButton(
                                                          onPressed: () =>
                                                              Navigator.pop(
                                                  ...
                                                  await showDialog<bool>(
                                                        ...
                                                        builder:
                                                          ...
                                                          return AlertDialog(
                                                            ...
                                                            content: const Text(
                                                                'Are you sure you want to join the game ? You can only chose another game after you finish this game'),
                                                            actions: [
                                                              TextButton(
                                                                onPressed: () =>
                                                                    Navigator.pop(
                                              ...
                                              await currentUserReference!
                                                ...
                                                currentGame: listViewGamesRecord
                                                    .reference,
                                              ));
