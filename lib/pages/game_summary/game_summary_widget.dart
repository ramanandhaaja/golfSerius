...
import 'game_summary_model.dart';
export 'game_summary_model.dart';
...
class _GameSummaryWidgetState extends State<GameSummaryWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GameSummaryModel());
                                            ...
                                            return ListView.builder(
                                              ...
                                              itemBuilder:
                                                ...
                                                return UserDetailScoreWidget(
                                                  key: Key(
                                                      'Keyi7q_${playerListIndex}_of_${playerList.length}'),
                                            ...
                                            return ListView.builder(
                                              ...
                                              itemBuilder:
                                                ...
                                                return UserDetailCustomScoreWidget(
                                                  key: Key(
                                                      'Key6vd_${playerListIndex}_of_${playerList.length}'),
                                                  userName: playerListItem
                                                      .displayName,
                                                  userDetail: playerListItem,
                                                  gameDetail:
